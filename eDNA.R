...
# Description: RScript for eDNA Data 

readRDS('Reads_PhyloseqObject.RDS')
...
# read abundance at the species level,"missing data"
...
# ggsave("phyloseq/reads_ordination.png", readOrdin, width = 14, height = 10, dpi = 300., bg = "white")